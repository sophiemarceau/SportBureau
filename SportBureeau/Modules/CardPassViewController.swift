...
class CardPassViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: "一卡通")
...
extension CardPassViewController:UITableViewDelegate,UITableViewDataSource{
