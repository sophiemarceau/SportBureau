//
//  BusSuccessViewController.swift
//  SportBureeau
//
...
class BusSuccessViewController: UIViewController {
    var resultModel:BusRQResult? = nil
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: "乘车成功")
...
extension BusSuccessViewController:UITableViewDelegate,UITableViewDataSource{
