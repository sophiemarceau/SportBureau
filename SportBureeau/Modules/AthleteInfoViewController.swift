...
class AthleteInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: "国家体育局运动员  信息公示")
...
extension AthleteInfoViewController:UITableViewDelegate,UITableViewDataSource{
