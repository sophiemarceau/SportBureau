...
class TrainGoalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: "国家运动员  训练指标")
...
extension TrainGoalViewController:UITableViewDelegate,UITableViewDataSource{
