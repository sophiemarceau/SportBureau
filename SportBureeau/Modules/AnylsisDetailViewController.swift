//
//  AnylsisDetailViewController.swift
//  SportBureeau
//
...
class AnylsisDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: imageName)
...
extension AnylsisDetailViewController:UITableViewDelegate,UITableViewDataSource{
