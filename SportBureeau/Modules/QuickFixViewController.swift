...
class QuickFixViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headImage = UIImage(named: "8671558882501_.pic")
...
extension QuickFixViewController:UITableViewDelegate,UITableViewDataSource{
